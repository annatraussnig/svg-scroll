...
svgScroll.reveal = function(percentage) {
    this.setDashOffset(percentage, 1);
}

svgScroll.revealReverse = function(percentage) {
    this.setDashOffset(percentage, -1);
}

svgScroll.setColor = function(c) {
    this.style.fill = c;
}

svgScroll.setRadius = function(r) {
    this.setAttribute('r', r);
}

svgScroll.setOpacity = function(o) {
    this.setAttribute('opacity', o);
}

svgScroll.setTop = function(t) {
    this.style.top = t + 'vh';
}
...
svgScroll.mapToScroll = function(scrollPositions, setPropertyMethod, propertyValues, interpolationFn) {
